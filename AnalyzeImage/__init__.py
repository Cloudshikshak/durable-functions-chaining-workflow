...
def main(imageName: str) -> str:
    ...
    response = requests.post('https://'+os.environ["COMPUTER_VISION_RESOURCE_NAME"]+'.cognitiveservices.azure.com/vision/v3.2/analyze?visualFeatures=Tags,Description&language=en&model-version=latest', headers=headers, data=blob_client.download_blob().readall())
